import { reviewIssues2 } from "../../api/collegeAdminQueries";
import {
	QueryClient,
	useMutation,
	useQueryClient,
...
export default function ReviewPage({ issues }: ReviewPageProps) {
	...
	const reviewStudentIssue2 = useMutation({
		mutationFn: reviewIssues2,
		onSuccess: (data) => {
			console.log(data);
	...
	const handleReview = (index: number) => {
		try {
            ...
            toast.promise(reviewStudentIssue2.mutateAsync(issue_id), {
